...
begin
  // When did the App get launched
  AppStartup := Now;

  // When was the last exception
  LastException := Now() - 1;

  // Continue startup after form creation
...
begin
  ...
  try
    ...
    begin
      ...
      LogException('Logging Startup', E.ClassName, E.Message, Query1.SQL.Text);
    end;
  end;
  ...
  try
    ...
    begin
      LogException('DBConnection Cleanup', E.ClassName, E.Message, DBConn.ConnectionName);
    end;
  end;
end;
