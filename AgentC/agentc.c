...
// Project has several segements split out to simplify things a bit
#include "agentc_queue.h"       // For queuing 
#include "agentc_logmessage.h"  // For handling LogMessage data
#include "agentc_logevent.h"    // For handling LogEvent data
